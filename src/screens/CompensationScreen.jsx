...
const total=e=>['base_pay','overtime_pay','allowance','kpi_bonus','output_bonus','delegation_bonus','other_bonus'].reduce((s,k)=>s+Number(e?.[k]||0),0)-Number(e?.advance_amount||0)-Number(e?.deduction_amount||0);
