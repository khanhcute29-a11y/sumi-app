-- Fix "column o.driver_name does not exist" — bảng orders chỉ có
-- shipper_staff_name (driver_name có thể là field JS tự thêm phía client
-- khi fetchOrders(), không phải cột thật trong DB). Bỏ điều kiện driver_name.
begin;
...
values('202609101320_fix_shipper_column_name', 'completed', now(),
  'Fix loi "column o.driver_name does not exist" - bang orders chi co shipper_staff_name, bo dieu kien driver_name.')
